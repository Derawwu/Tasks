...
namespace EntityFrameworkSpecflow.Models
{
    public partial class NorthwindContext : DbContext
    {
        private const string CONNECTION_STRING = "Data Source=DESKTOP-H7HOOPQ;Initial Catalog=Northwind;Integrated Security=True";
